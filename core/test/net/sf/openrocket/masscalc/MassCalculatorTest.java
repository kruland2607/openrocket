...
public class MassCalculatorTest extends BaseTestCase {
	...
	private final double BOOSTER_TOTAL_DRY_MASS_EA = 0.4555128227852;
...
//		System.err.println( treeDump);
		...
		double expMass = BOOSTER_TOTAL_DRY_MASS_EA;
...
//		System.err.println( treeDump);
		{
			...
			double expTotalMass = BOOSTER_TOTAL_DRY_MASS_EA + 8*G77_MASS_LAUNCH;
		...
		}
		{
			...
			double expTotalMass = BOOSTER_TOTAL_DRY_MASS_EA + 8*0.064;
...
//		System.err.println( rocket.toDebugTree());
	...
	@Test
	public void testComponentCMOverride() {
		Rocket rocket = TestRockets.makeFalcon9Heavy();
		FlightConfiguration config = rocket.getSelectedConfiguration();
		rocket.setName("TestRocket."+Thread.currentThread().getStackTrace()[1].getMethodName());
